                ...
                <div className="row" >
                        ...
                        Order below 100/- include additional <br /> delivery charges..<br />
                            ...
                            <div className="row left-col-row0" style={{
                                ...
                                <div className="col-md-6 img1"> <img src={samosa} alt="some img" /> </div>
                                <div className="col-md-6 img2"><img src={dosa} alt="some img" /> </div>  
                                </div>
                                ...
                                <div className="col-md-6 img1"> <img src={momos} alt="momos" /> </div>
                                <div className="col-md-6 img2"><img src={noodles} alt="noodles" /> </div>  
                                </div>
                            </div>            
                            </div>
...
<img src={props.img} alt="item" style={{
    width: '200px',
    height: '170px',
    borderRadius: ''
}} />
