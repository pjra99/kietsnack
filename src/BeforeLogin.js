    ...
    return (
      <div className="before-login-screen container-fluid">
        <div className="row row1">
          <div className="col-md-4 heading-title">
        ...
        <div className="row row2">
          ...
          <div className="col-md-7">
            <div className="row header-center-title">
              Get your favourite canteen food <br />
              delivered at your hostel! <br />
            </div>
            <div className="row">
            ...
            <div className="row buttons">
              ...
              <div className="col-sm-3">
                <Link to="/signin">
                  {" "}
                  <button className="signInStu" type="submit">
                    Sign in as Student
                    <BsFillPersonFill />
                  </button>
                </Link>
        ...
        <div className="row middle">
          ...
          <div className="row canteen-images">
            ...
            <div className="col-md-4 img1">
              <Canteens img={bigtreat} />
            </div>
            <div className="col-md-4 img2">
              <Canteens img={cafeteria} />{" "}
            </div>
            <div className="col-md-2"></div>
          </div>
          <div className="row canteen-images">
        ...
        <div className="row footer">
          <h4 className="footer-phrase">
            KIET FOODS | All Rights Reserved &copy;
          </h4>
        </div>
      </div>
    );
